...
dataset.emore.dataset_path = '/home/huangju/codes/insightface/datasets/dataset_large'
dataset.emore.num_classes = 5319
dataset.emore.image_shape = (112,112,3)
dataset.emore.val_targets = ['faces']
