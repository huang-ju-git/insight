...
def test(args):
    ...
    with open("msmt_face_q_t-own-best.pkl","wb") as f: 
        pickle.dump(d,f)

def cal():
    #读取人脸特征
    face_features=pickle.load(open('/home/huangju/codes/insightface/deploy/msmt_face_q_t-own-best.pkl', 'rb'))
...
if __name__ == '__main__':
    ...
    base_path='/home/huangju/codes/insightface/recognition/ArcFace/models8-2/r100-softmax-emore/model,'
